				...
				<nav class='navbar navbar-inverse navbar-fixed-top' ng-controller='HeaderController' role='navigation' style='border-radius:0px;'>
					...
					<div class='collapse navbar-collapse navbar-ex1-collapse'>
						<ul class='nav navbar-nav'>
							...
							<li>
								<a class="" type="button" data-toggle="dropdown" style="cursor: pointer;">Inventario<span class="caret"></span></a>
							...
							<li>
								<a class="" type="button" data-toggle="dropdown" style="cursor: pointer;">Clientes<span class="caret"></span></a>
								<ul class="dropdown-menu">
							...
							<?php } ?>
							<li>
								<a class="" type="button" data-toggle="dropdown" style="cursor: pointer;">Movimientos<span class="caret"></span></a>
								<ul class="dropdown-menu">
							...
							<?php if (isset($_SESSION['Id']) && isset($_SESSION['Nivel']) && $_SESSION['Nivel'] ==2 || $_SESSION['Nivel'] ==3) { ?>
							<li>
								<a class="" type="button" data-toggle="dropdown" style="cursor: pointer;">Efectivo<span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li>
							...
							<li>
								<a class="" type="button" data-toggle="dropdown" style="cursor: pointer;">Reportes<span class="caret"></span></a>
								<ul class="dropdown-menu">
									...
									<!--reportes nuevos-->
									<li><a href="buscar_reporte_abonos_creditos.php" style="cursor: pointer;">Reporte Abonos Creditos</a></li>
									<li><a href="buscar_reportes_traslados.php" style="cursor: pointer;">Reporte de Traslados</a></li>
									<li><a href="buscar_reportes_trs.php" style="cursor: pointer;">Reporte de Salida traslados</a></li>
							...
							<li>
								<a class="" type="button" data-toggle="dropdown" style="cursor: pointer;">Cierres<span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li>
