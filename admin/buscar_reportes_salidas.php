						...
						<div class="panel-body">
							<div class='table-responsive'>
								<table class='table table-striped table-bordered' id='tabla_datos'>
									...
									foreach ($data as $row) {?>
									<tr>
										<td>Reporte de salidas</td>
										<td><?php echo $row['Fecha'] ?></td>
										<td><?php echo $row['Numero'] ?></td>
										<td><a href="#" class='btn btn-success' onclick='Buscar_salidas(<?php echo $row[0]; ?>)' >Mostrar</a> <a href="reporte_salidas.php?imp=<?php echo $row[0]; ?>&ubicacion=0" class='btn btn-primary'>Imprimir</a></td>
									</tr>
									<?php }?>
								</table>
							</div>
