...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <div id="entradas">
            <div class="col-xs-6">
                <input type="text" value="<?php echo $n_factura ?>" id="N_factura" class="form-control"
                    placeholder='N de factura' required <?php echo $disabled; ?>><br>
                <input id="Cod" list="Cod_producto" class="form-control" onchange="buscar($(this).val(),3)"
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <a href="guardar_entradas.php?guardar=1" class="btn btn-primary"
								...
								foreach ($r as $k):
									if($k[0] != null): ?>
										<tr>
											...
											<td><?php echo $k[3]; ?></td>
											<td><?php echo $k[7]; ?></td>
											<td><a class='btn btn-danger' onclick='eliminar_entrada(<?php echo $i;  ?>,0)'
