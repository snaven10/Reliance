						...
						<div class="panel-body">
									...
									<tbody>
										<tr>
											<td>
												...
												<a href="guardar_trs.php?guardar=1" class="btn btn-primary" style="float: right;">Guardar Salidas traslado</a>
											</td>
										</tr>
									</tbody>
								</table>
							...
							<div class="col-xs-12"><br>
								<table class='table table-striped table-bordered' id='tabla_datos'>
									<CENTER><h2>REPORTE DE SALIDAS DE TRASLADOS <?php echo date('d-m-Y'); ?></h2></CENTER>
									<thead>
										<tr>
											<th>Cod Producto</th>
											<th>Nombre</th>
