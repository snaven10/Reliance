...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <div id="entradas">
            <div class="col-xs-6">
                <b>Cod Producto:</b>
                <input id="Cod-s" list="Cod_producto" class="form-control" onchange="buscar($(this).val(),3)"
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <a href="guardar_salidas.php?guardar=1" class="btn btn-primary"
                                style="float: right;">Guardar Salidas</a>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="col-xs-12"><br>
            <table class='table table-striped table-bordered' id='tabla_datos'>
                <CENTER>
                    <h2>REPORTE DE SALIDAS <?=  date('d-m-Y'); ?></h2>
                </CENTER>
                <thead>
                    <tr>
                        <th>Cod Producto</th>
								...
								foreach ($r as $k):
									if($k[0] != null): ?>
										<tr>
											...
											<td><?= $k[1]; ?></td>
											<td><?= $k[2]; ?></td>
											<td><a class='btn btn-danger' onclick='eliminar_salida(<?=  $i;  ?>)'
