...
$cierre = new cierre();
$gastos = $cierre->get_egresos_fecha(date('Y-m-d').' 05:00:00',date('Y-m-d H:i:s'));
        ?>
                    <ol class="breadcrumb">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h1 class='text-center'>Reporte de Egresos</h1>
                        </div>
                            ...
                            <div class='table-responsive'>
                                ...
                                <div id="Carga">
                                    <table class='table table-striped table-bordered' id=''>
                                        <CENTER><h2>REPORTE DE EGRESOS <?php echo date('d-m-Y'); ?></h2></CENTER>
                                        <thead>
                                            <tr>
                                                <th>Fecha Hora</th>
                                                <th>Descripcion</th>
