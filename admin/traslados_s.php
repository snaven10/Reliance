...
<ol class="breadcrumb">
    ...
    <li class="active">Salidas de traslado</li>
</ol>
<div class="panel panel-primary">
    <div class="panel-heading">
        <h1 class='text-center'>Salidas de traslado</h1>
    </div>
    <div class="panel-body">
        ...
        <div class="col-xs-12"><br>
            <table class='table table-striped table-bordered' id='tabla_datos'>
                <CENTER>
                    <h2>REPORTE DE SALIDAS DE TRASLADOS <?php echo date('d-m-Y'); ?></h2>
                </CENTER>
                <thead>
                    <tr>
                        <th>Cod Producto</th>
								...
								foreach ($r as $k):
									if($k[0] != null): ?>
										<tr>
											...
											<td><?php echo $k[1]; ?></td>
											<td><?php echo $k[2]; ?></td>
											<td><a class='btn btn-danger' onclick='eliminar_salida(<?php echo $i;  ?>)'
