...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
       <!-- <a href="add_producto.php" class='btn btn-info'>Nuevo producto</a>-->
        <a onClick="modal_add()" class='btn btn-info'>Nuevo producto</a>
            ...
            <table class='table table-bordered table-hover' id='tabla_datos'>
                ...
                <tbody class="result">
                    ...
                    <tr <?php if ($precio1[0][1] == 0) { ?> class="danger" style="cursor: pointer;" <?php }else{
                        ...
                        onclick="modal('<?php echo $row['Id_producto'] ?>');">
                        <td><?php echo $row['Cod_producto'] ?></td>
                        <td><?php echo $row['Cod_oem'] ?></td>
                        <td><?php $cod_reemplazo = $producto->get_id_cod_reemplazo($row['Id_producto']); echo $cod_reemplazo[0][1]; ?>
                        </td>
                        <td><?php echo $precio1[0][1]; ?></td>
                        <td><?php echo $row['Nombre'] ?></td>
                        <td><?php echo $row['Descripcion'] ?></td>
                        <td><?php $proveedor1 = $proveedor->get_id_proveedor($row['Id_proveedor']); echo $proveedor1[0][1] ?>
                        </td>
                    </tr>
                    <?php $i++; }?>
                </tbody>
