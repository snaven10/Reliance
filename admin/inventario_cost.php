	...
	<ol class="breadcrumb">
					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h1 class='text-center'>Reporte Inventario costo</h1>
						</div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
												...
												<center>
													<a onclick="inventario_cost($('#Estante').val(),1)" class='btn btn-info'>Generar</a>
												</center>
                                            </td>
                                            <td>
                                            	<center>
                                            ...
                                            <td>
												...
												<center>
													<a onclick="inventario_cost($('#Codigo').val(),2)" class='btn btn-info'>Generar</a>
												</center>
                                            </td>
                                        </tr>
                                    </tbody>
