			...
			?>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div id="entradas">
								<div class="col-xs-6">
									<input type="text" value="<?php echo $N_traslado ?>" id="N_traslado" class="form-control" placeholder='N de traslado' required <?php echo $disabled; ?>><br>
									<input id="Cod" list="Cod_producto" class="form-control" onchange="buscar($(this).val())" placeholder='Cod producto' required>
									...
									<tbody>
										<tr>
											<td>
												...
												<a href="guardar_trasladosente.php?guardar=1" class="btn btn-primary" style="float: right;">Guardar Entrada</a>
											</td>
										</tr>
									</tbody>
								</table>
													...
													foreach ($r as $k) {
														if($k[0] != null){?>
															<tr>
																...
																<td><?php echo $k[3]; ?></td>
																<td><?php echo $k[7]; ?></td>
																<td><a class='btn btn-danger' onclick='eliminar_trasladosentr(<?php echo $i;  ?>,0)' id='eliminar_ss'><span class='glyphicon glyphicon-remove'></span></a></td>
															</tr>
														<?php }	
													}
												} 
