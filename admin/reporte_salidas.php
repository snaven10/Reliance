...
if (isset($_POST['id']) && $_POST['tipo'] == 1) {
	...
	<div class="modal-footer">
        <a href='reporte_salidas.php?imp=<?php echo $_POST['id']; ?>&ubicacion=0' class='btn btn-success'>Imprimir</a>
...
include '../clases/clase_entradas.php';
$entradas = new entradas();
$data = $reporte_entrada->get_id_salidas($_GET['imp']);
	?>
...
<div class="container" style='width:189mm; height:10mm; text-align: center;' id='imp_rep'>
	<table class='table table-striped table-bordered' id='tabla_datos'>
		<CENTER><h3>REPORTE DE SALIDAS DE PRODUCTO N <?php $entradas1 = $entradas->get_id_salidas($_GET['imp']); echo $entradas1[0][2]." ".$entradas1[0][1] ?></h3></CENTER>
		<thead>
			<tr>
				<th>Cod Producto</th>
				<th>Nombre</th>
...
<script type="text/javascript">
    ...
    <?php if ($_GET['ubicacion']==0) {
		echo "location.href='buscar_reportes_salidas.php';";
	}elseif ($_GET['ubicacion']==1) {
		echo "location.href='salidas.php';";
	} ?>
</script>
<?php
}
